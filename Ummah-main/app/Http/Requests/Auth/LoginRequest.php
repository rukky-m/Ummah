...
class LoginRequest extends FormRequest
{
    ...
    public function authenticate(): void
    {
        ...
        // Staff and Admins are exempt from this check as they bypass member status requirements
        if (!$user->isStaff() && $user->member && $user->member->status !== 'active') {
            Auth::logout();
            
            $message = $user->member->status === 'pending' 
